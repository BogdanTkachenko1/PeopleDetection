...
class Crowd_human:
    ...
    root_folder = '../../../datasets/night_dataset_labeled'
    image_folder = '../../../datasets/night_dataset_labeled/Images'
    train_source = os.path.join('../../../datasets/night_dataset_labeled/train_annotations.odgt')
    eval_source = os.path.join('../../../datasets/night_dataset_labeled/val_annotations.odgt')
...
class Config:
    ...
    pretrain_weight = '../../../resnet50_fbaug_76254_4e14b7d1.pkl'
